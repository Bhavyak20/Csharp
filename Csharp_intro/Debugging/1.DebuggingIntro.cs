...
class DebuggingIntro
{
    static void Main(string[] args)
    {
        ...
        string LakshmiDetails = getLakshmiDetails();

        PrintAllCheckPointsList();

        string EmDetails = getEmpDetailsByEmpName("Lakshmi");
        Console.WriteLine(EmDetails);
    ...
    static void PrintFirstCheckPoint()
    {
        ...
        Console.WriteLine($"Showing the data of Check Point 1 : {empName} , {empAge} {empSalary}");
    }
